...
url='https://raw.githubusercontent.com/DuaneIndustries/colonialgantt/main/Colonial_Coffee_Gantt_17.csv'
...
start_dates = pd.date_range(start='2025-03-24', end='2025-06-15', freq='W-MON')
