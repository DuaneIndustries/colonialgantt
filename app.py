...
url='https://raw.githubusercontent.com/DuaneIndustries/colonialgantt/main/Colonial_Coffee_Gantt_v20.csv'
...
start_dates = pd.date_range(start='2025-03-24', end='2025-07-13', freq='W-MON')
...
def update_gantt(all_rows_data, slctd_row_indices, slct_rows_names, slctd_rows,
    ...
    fig = dcc.Graph(id='gantt-chart', figure=px.timeline(
            ...
            color_discrete_map={
                "Project Coordination" : "red",
                "Installation" : "blue" ,
                "Programming" : "goldenrod",
                "Start Up" : "blueviolet", 
                "Electrical" :"grey", 
                "Delivery" :"green"}, 
            opacity=.5,
